...
namespace ColumnsGame.ViewModel
{
    public partial class GameWindowViewModel
    {
        ...
        private void stopGame()
        {
            ...
            if (MessageBox.Show("Ukočit hru?", "Stop...", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
                GameOver = true;
                Board.StopGame();
            }
        ...
        {
            GameRunnig = false;
            MessageBox.Show("Pokračovat ve hraní?", "Pauza...", MessageBoxButton.OK, MessageBoxImage.Question);
            GameRunnig = true;
        ...
        #region Setting button command method
